...
<section class="pagehero pagehero--photo" style="--photo:url('/Streamline-Plumbing/assets/img/home-plumber-how-we-work-2-700.webp')"><div class="wrap">
  <p class="crumbs"><a href="/Streamline-Plumbing/">Home</a> / <a href="/Streamline-Plumbing/services">Services</a> / Maintenance</p>
  <h1>Maintenance</h1>
  <p class="lede">Planned maintenance for homes, estates, businesses and body corporates — catch small leaks before they become damage.</p>
  <span class="tag">Nelspruit · White River</span>
</div></section>
<section class="section"><div class="wrap split">
  <div class="copy">
    <span class="eyebrow">Maintenance — what we do</span>
    ...
    <ul class="ticklist"><li>Geyser services & anode checks</li><li>Leak detection & pressure testing</li><li>Drain cleaning & gully maintenance</li><li>Valve, tap & toilet servicing</li><li>Estate & body corporate maintenance plans</li><li>Service level agreements (SLAs)</li></ul>
    ...
    <div class="areas"><a href="/Streamline-Plumbing/areas/nelspruit-maintenance">Maintenance in Nelspruit</a><a href="/Streamline-Plumbing/areas/white-river-maintenance">Maintenance in White River</a></div>
  </div>
...
<section class="ctaband"><div class="wrap">
  ...
  <p>Call 082 900 3389 for emergencies, or book maintenance at a time that suits you.</p>
