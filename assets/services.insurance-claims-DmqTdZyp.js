...
<section class="pagehero pagehero--photo" style="--photo:url('/Streamline-Plumbing/assets/img/img-5483-800.webp')"><div class="wrap">
  <p class="crumbs"><a href="/Streamline-Plumbing/">Home</a> / <a href="/Streamline-Plumbing/services">Services</a> / Insurance Claims</p>
  <h1>Insurance Claims</h1>
  <p class="lede">Burst geyser or storm damage? We handle the assessment, report and repair so your claim goes through smoothly.</p>
  <span class="tag">Nelspruit · White River</span>
</div></section>
<section class="section"><div class="wrap split">
  <div class="copy">
    <span class="eyebrow">Insurance Claims — what we do</span>
    ...
    <ul class="ticklist"><li>Burst geyser claim assessments</li><li>Detailed damage reports & photos for insurers</li><li>Like-for-like replacement quotes</li><li>Emergency make-safe work</li><li>Resultant damage identification</li><li>Direct liaison with assessors</li></ul>
    ...
    <div class="areas"><a href="/Streamline-Plumbing/areas/nelspruit-insurance-claims">Insurance Claims in Nelspruit</a><a href="/Streamline-Plumbing/areas/white-river-insurance-claims">Insurance Claims in White River</a></div>
  </div>
...
<section class="ctaband"><div class="wrap">
  ...
  <p>Call 082 900 3389 for emergencies, or book insurance claims at a time that suits you.</p>
