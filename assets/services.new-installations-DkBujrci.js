...
<section class="pagehero pagehero--photo" style="--photo:url('/Streamline-Plumbing/assets/img/1-150l-solar-geyser-800.webp')"><div class="wrap">
  <p class="crumbs"><a href="/Streamline-Plumbing/">Home</a> / <a href="/Streamline-Plumbing/services">Services</a> / New Installations</p>
  <h1>New Installations</h1>
  <p class="lede">Geysers, solar systems, heat pumps, main water lines and full plumbing installations for new builds and renovations.</p>
  <span class="tag">Nelspruit · White River</span>
</div></section>
<section class="section"><div class="wrap split">
  <div class="copy">
    <span class="eyebrow">New Installations — what we do</span>
    ...
    <ul class="ticklist"><li>Electric & solar geyser installations</li><li>Heat pumps & timers</li><li>Main water lines & stop taps</li><li>Bathroom & kitchen plumbing for new builds</li><li>Drainage & gully installations</li><li>JoJo tank & backup water hookups</li></ul>
    ...
    <div class="areas"><a href="/Streamline-Plumbing/areas/nelspruit-new-installations">New Installations in Nelspruit</a><a href="/Streamline-Plumbing/areas/white-river-new-installations">New Installations in White River</a></div>
  </div>
...
<section class="ctaband"><div class="wrap">
  ...
  <p>Call 082 900 3389 for emergencies, or book new installations at a time that suits you.</p>
