...
<section class="pagehero pagehero--photo" style="--photo:url('/Streamline-Plumbing/assets/img/new-shower-800.webp')"><div class="wrap">
  <p class="crumbs"><a href="/Streamline-Plumbing/">Home</a> / <a href="/Streamline-Plumbing/services">Services</a> / Relocations</p>
  <h1>Relocations</h1>
  <p class="lede">Moving a geyser, bathroom or kitchen? We re-route water and drainage safely and to code.</p>
  <span class="tag">Nelspruit · White River</span>
</div></section>
<section class="section"><div class="wrap split">
  <div class="copy">
    <span class="eyebrow">Relocations — what we do</span>
    ...
    <ul class="ticklist"><li>Geyser relocations (roof, wall or external)</li><li>Kitchen & bathroom re-routing during renovations</li><li>Washing machine & dishwasher points</li><li>Outdoor tap & irrigation supply points</li><li>Drainage re-routing & fall correction</li><li>Solar system repositioning</li></ul>
    ...
    <div class="areas"><a href="/Streamline-Plumbing/areas/nelspruit-relocations">Relocations in Nelspruit</a><a href="/Streamline-Plumbing/areas/white-river-relocations">Relocations in White River</a></div>
  </div>
...
<section class="ctaband"><div class="wrap">
  ...
  <p>Call 082 900 3389 for emergencies, or book relocations at a time that suits you.</p>
