...
<header class="hdr"><div class="wrap">
  ...
  <nav class="nav" id="nav" aria-label="Main"><a href="/">Home</a><a href="/about-us">About Us</a><a href="/services">Services</a><a href="/gallery">Gallery</a><a href="/blog">Blog</a><a href="/contact-us">Contact Us</a><a class="btn btn-lime btn-quote" href="/contact-us">Get a Quote</a></nav>
</div></header>
<main id="main">
<section class="pagehero pagehero--photo" style="--photo:url('/assets/img/img-2-800.webp')"><div class="wrap">
  <p class="crumbs"><a href="/">Home</a> / Schedule Now</p>
  <h1>Schedule an appointment</h1>
  <p class="lede">Emergencies: call 082 900 3389 right now. For everything else, the form below gets you a confirmed time and a straight quote.</p>
</div></section>
...
<div class="formcard">
  ...
  <div>
    <div class="infocard">
      <div class="row"><strong>What happens next</strong>
        <ul class="ticklist" style="margin-top:.8rem">
          <li>We call you back to confirm details</li>
          <li>You get a time window and a written quote</li>
          <li>Our team arrives, fixes it, and cleans up</li>
          <li>Warranty and paperwork in your inbox</li>
        </ul></div>
      <div class="row"><strong>Emergency?</strong><a class="spec" href="tel:+27829003389">CALL 082 900 3389</a></div>
    </div>
  </div>
</div></section>

<section class="section"><div class="wrap"><div class="g-strip"><a class="g-tile g-1 has-photo" href="/gallery" style="--photo:url('/assets/img/1-150l-solar-geyser-800.webp')"><span>Solar geyser install</span></a><a class="g-tile g-2 has-photo" href="/gallery" style="--photo:url('/assets/img/new-gully-to-main-drian-800.webp')"><span>Drainage repair</span></a><a class="g-tile g-3 has-photo" href="/gallery" style="--photo:url('/assets/img/new-shower-800.webp')"><span>Bathroom renovation</span></a></div></div></section>
