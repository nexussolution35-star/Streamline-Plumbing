...
<section class="hero hero--overlay hero--form"><div class="heroshot"><div class="drop" role="img" aria-label="Streamline water drop emblem"></div></div><div class="wrap hero__wrap">
  <div class="hero__content">
    ...
    <a class="gbadge gbadge--fb" href="https://www.facebook.com/streamlineplumbings/mentions/" target="_blank" rel="noopener" aria-label="Follow Streamline Plumbing on Facebook">
      <span class="gbadge__g" aria-hidden="true"><svg viewBox="0 0 24 24" width="22" height="22" fill="#1877F2"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.96h-1.51c-1.49 0-1.96.93-1.96 1.89v2.26h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z"/></svg></span>
      <span class="gbadge__txt"><strong>@streamlineplumbings</strong></span>
    </a>
    </div>
